{
  ...
  # Use the nordvpn package from the flake, substituting buildFHSEnv for deprecated buildFHSEnvChroot
  nordVpnPkg = pkgs.callPackage "${inputs.nordvpn-flake}/nordvpn.nix" {
    buildFHSEnvChroot = pkgs.buildFHSEnv;
  };
in {

...
PROMPT_DIRTRIM=2                         # Shorten deep paths in the prompt
PS1='\[\033]0;Git | Bash v\v | \W\007\]' # set window title
#PS1="$PS1"'\n'                           # new line
PS1="$PS1"'\[\033[0m\][\A] '        # black text, magenta, 24h time
#PS1="$PS1"'\[\033[30;42m\]\u '          # black text, green, user
#PS1="$PS1"'\[\033[30;42m\]@\h '          # black text, green, @host
PS1="$PS1"'\[\033[1;32m\]\w'          # black text, yellow, working director
...
then
    ...
    then
        ...
        PS1="$PS1"'\[\033[1;35m\]'  # white text, cyan
